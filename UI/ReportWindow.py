...
"}"))
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 484, 397))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 484, 397))
        ...
        self.horizontalLayout_2.addWidget(self.availableFilters)
        self.activeFilters = QtGui.QListWidget(self.page_2)
        self.activeFilters.setObjectName(_fromUtf8("activeFilters"))
        self.horizontalLayout_2.addWidget(self.activeFilters)
