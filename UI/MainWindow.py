...
"QIcon{background-color:rga(1,1,1);}"))
        ...
        self.clientList.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        self.clientList.setSelectionMode(QtGui.QAbstractItemView.SingleSelection)
        self.clientList.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
