...
"}"))
        ...
        self.gridLayout_2 = QtGui.QGridLayout(self.billingGroup)
        ...
        self.frame_4 = QtGui.QFrame(self.billingGroup)
        self.frame_4.setStyleSheet(_fromUtf8("QFrame{ background-color: rgb(248, 233, 210); }"))
        ...
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.FieldRole, self.phone1)
        ...
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.FieldRole, self.phone2)
        ...
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.FieldRole, self.email)
    ...
    def retranslateUi(self, MatterWindow):
        ...
        self.label_12.setText(_translate("MatterWindow", "Phone 1", None))
        self.label_13.setText(_translate("MatterWindow", "Phone 2", None))
        self.label_18.setText(_translate("MatterWindow", "Email", None))
